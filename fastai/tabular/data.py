...
class TabularDataLoaders(DataLoaders):
    ...
    def from_df(cls,
        ...
        procs:listy[TabularProc]|None=None, # List of `TabularProc`s
        cat_names:listy[str]|None=None, # Column names pertaining to categorical variables
        cont_names:listy[str]|None=None, # Column names pertaining to continuous variables
        y_names:listified[str]|None=None, # Names of the dependent variables
        y_block:listified[TransformBlock]|None=None, # `TransformBlock` to use for the target(s)
        valid_idx:listy[int]|None=None, # List of indices to use for the validation set, defaults to a random split
        **kwargs
    ):
    ...
    def test_dl(self,
        ...
        rm_type_tfms:int|None=None, # Number of `Transform`s to be removed from `procs`
