...
def untar_data(
    url:str, # File to download
    archive:str|Path|None=None, # Override for `Config`'s `archive` key
    data:str|Path|None=None, # Override for `Config`'s `data` key
    c_key:str='data', # Key in `Config` where to extract file
    force_download:bool=False # Overwrite any existing copy of data
